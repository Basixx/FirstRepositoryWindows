...
public class CrudAppTestSuite {
    ...
    private static final String BASE_URL = "https://basixx.github.io/";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException{
        ...
        driverTrello.findElement(By.id("user")).sendKeys("basienkarutkowska@gmail.com");
        driverTrello.findElement(By.id("password")).sendKeys("MOB35%san");
